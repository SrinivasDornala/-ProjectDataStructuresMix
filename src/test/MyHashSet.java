    ...
    implements Set<E>, Cloneable, java.io.Serializable
{
    ...
    public boolean add(E e) {
    	System.out.println("MyHashSet.add()");
        return map.put((String)e, "")==null;
    }
    ...
    public Object clone() {
        try {
            ...
            newSet.map = (MyHashMap) map.clone();
            return newSet;
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        map = (((MyHashSet)this) instanceof MyLinkedHashSet ?
               new MyLinkedHashMap(capacity, loadFactor) :
               new MyHashMap(capacity, loadFactor));
